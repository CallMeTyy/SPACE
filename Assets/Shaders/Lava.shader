	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color219 = IsGammaSpace() ? float4(1,0.5860485,0,0) : float4(1,0.3025048,0,0);
				
				float3 Albedo = color219.rgb;
...
/*ASEBEGIN
Version=18900
6.666667;6;1693.333;885;-4790.7;322.7381;1;True;True
Node;AmplifyShaderEditor.ColorNode;219;5344.7,33.2619;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;1,0.5860485,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=28D399A942DCD33FAE145904F3995E25EC6303A8